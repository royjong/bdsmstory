        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-md h-auto">
              <Image
                src="https://media.s-bol.com/JVWD8Vx06Yv/550x778.jpg"
                layout="responsive"
                width={200}
                height={300}
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-8">
      <div className="text-teal-600">
          <Image src="/bdsm.png" width={200} height={200} alt="logo"/>
      </div>
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75">E-book  </a>
            </li>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">Onze gegevens</p>
Name
          <ul className="mt-6 space-y-4 text-sm">
            <li>
